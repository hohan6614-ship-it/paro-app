...
function IconWave() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M2 17 C3.5 14.5,5 14.5,6.5 17" opacity="0.35"/>
    </svg>
  )
}
function IconPerson() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round">
      ...
      <circle cx="18" cy="8" r="2.5" opacity="0.45"/><path d="M21 21C21 19 20 17.5 18 17" opacity="0.45"/>
    </svg>
  )
}
function IconGrid() {
...
// 목적: 황토/금색 | 소리: 청록 | 아티스트: 적갈색 | 둘러보기: 먹색
const entries = [
  { title: '목적부터 찾기',      desc: '영상, 게임, 공연, 광고 등\n용도에 맞는 소리를 찾아요', Icon: IconTarget, href: '/search?axis=purpose', bg: '#FEF4E4', color: '#8A5A2B' },
  { title: '소리·분위기로 찾기', desc: '악기, 정서, 장단으로\n원하는 느낌을 탐색해요',     Icon: IconWave,   href: '/search?axis=sound',   bg: '#E6F4F2', color: '#1E7C73' },
  { title: '아티스트부터 찾기',  desc: '작곡가, 연주자, 보컬 등\n직접 아티스트를 만나요',  Icon: IconPerson, href: '/search?tab=artist',   bg: '#FBEEE9', color: '#C45532' },
  { title: '그냥 둘러보기',      desc: '큐레이션된 추천 컬렉션으로\n영감을 찾아요',         Icon: IconGrid,   href: '/search?tab=all',     bg: '#EDECE8', color: '#3D3530' },
]
